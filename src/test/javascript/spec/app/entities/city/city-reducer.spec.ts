...
describe('Entities reducer tests', () => {
  ...
  describe('Requests', () => {
    ...
    it('should set state to updating', () => {
      testMultipleTypes(
        [REQUEST(ACTION_TYPES.CREATE_CITY), REQUEST(ACTION_TYPES.UPDATE_CITY), REQUEST(ACTION_TYPES.DELETE_CITY)],
        {},
        state => {
          expect(state).toMatchObject({
            errorMessage: null,
    ...
    it('should set a message in errorMessage', () => {
      testMultipleTypes(
        [
          ...
          FAILURE(ACTION_TYPES.DELETE_CITY)
        ],
        'error message',
        state => {
          expect(state).toMatchObject({
  ...
  describe('Successes', () => {
    ...
    it('should fetch a single entity', () => {
      ...
      expect(
        reducer(undefined, {
          type: SUCCESS(ACTION_TYPES.FETCH_CITY),
          payload
        })
      ).toEqual({
        ...initialState,
    ...
    it('should create/update entity', () => {
      ...
      expect(
        reducer(undefined, {
          type: SUCCESS(ACTION_TYPES.CREATE_CITY),
          payload
        })
      ).toEqual({
        ...initialState,
    ...
    it('should delete entity', () => {
      ...
      const toTest = reducer(undefined, {
        type: SUCCESS(ACTION_TYPES.DELETE_CITY),
        payload
      });
  ...
  describe('Actions', () => {
    ...
    it('dispatches ACTION_TYPES.FETCH_CITY actions', async () => {
      const expectedActions = [
        {
          type: REQUEST(ACTION_TYPES.FETCH_CITY)
        },
        {
          type: SUCCESS(ACTION_TYPES.FETCH_CITY),
          payload: resolvedObject
    ...
    it('dispatches ACTION_TYPES.CREATE_CITY actions', async () => {
      const expectedActions = [
        {
          type: REQUEST(ACTION_TYPES.CREATE_CITY)
        },
        {
          type: SUCCESS(ACTION_TYPES.CREATE_CITY),
          payload: resolvedObject
    ...
    it('dispatches ACTION_TYPES.UPDATE_CITY actions', async () => {
      const expectedActions = [
        {
          type: REQUEST(ACTION_TYPES.UPDATE_CITY)
        },
        {
          type: SUCCESS(ACTION_TYPES.UPDATE_CITY),
          payload: resolvedObject
        },
        {
          type: REQUEST(ACTION_TYPES.FETCH_CITY_LIST)
    ...
    it('dispatches ACTION_TYPES.DELETE_CITY actions', async () => {
      const expectedActions = [
        {
          type: REQUEST(ACTION_TYPES.DELETE_CITY)
        },
        {
          type: SUCCESS(ACTION_TYPES.DELETE_CITY),
          payload: resolvedObject
