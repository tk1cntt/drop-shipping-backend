...
/**
 * REST controller for managing {@link com.dropshipping.domain.Region}.
 */
@RestController
@RequestMapping("/api")
public class RegionResource {
     ...
     */
    @GetMapping("/regions")
    public ResponseEntity<List<RegionDTO>> getAllRegions(RegionCriteria criteria, Pageable pageable, @RequestParam MultiValueMap<String, String> queryParams, UriComponentsBuilder uriBuilder) {
