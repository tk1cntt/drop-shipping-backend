  ...
  render() {
    ...
    return (
      <Modal isOpen toggle={this.handleClose}>
        ...
        <ModalBody id="dropshippingApp.userProfile.delete.question">
          <Translate contentKey="dropshippingApp.userProfile.delete.question" interpolate={{ id: userProfileEntity.id }}>
