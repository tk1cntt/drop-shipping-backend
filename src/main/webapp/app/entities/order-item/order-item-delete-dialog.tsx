  ...
  render() {
    ...
    return (
      <Modal isOpen toggle={this.handleClose}>
        ...
        <ModalBody id="dropshippingApp.orderItem.delete.question">
          <Translate contentKey="dropshippingApp.orderItem.delete.question" interpolate={{ id: orderItemEntity.id }}>
