    ...
    return (
      <div>
        <h2 id="order-comment-heading">
          <Translate contentKey="dropshippingApp.orderComment.home.title">Order Comments</Translate>
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="dropshippingApp.orderComment.home.createLabel">Create new Order Comment</Translate>
          </Link>
        </h2>
            ...
            <tbody>
              {orderCommentList.map((orderComment, i) => (
                <tr key={`entity-${i}`}>
                  ...
                  <td>
                    <Translate contentKey={`dropshippingApp.CommentType.${orderComment.type}`} />
                  </td>
                  <td>
